...
User documentation and technical guides for oh-my-codebuddy.

## Purpose

This directory contains documentation for end-users and developers:

- **End-user guides**: How to use oh-my-codebuddy features
...
| File | Description |
|------|-------------|
| `CODEBUDDY.md` | End-user orchestration instructions (installed to user projects) |
...
1. **End-User Focus**: CODEBUDDY.md is installed to user projects - write for end-users, not developers
2. **Keep Links Accessible**: Use raw GitHub URLs for links in CODEBUDDY.md (agents can't navigate GitHub UI)
...
| Agent tool assignments change | `CODEBUDDY.md` (Agent Tool Matrix) |
...
| End-user instructions change | `CODEBUDDY.md` |
