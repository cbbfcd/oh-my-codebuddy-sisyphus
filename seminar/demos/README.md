...
### Required Setup
- OMC installed and configured (`/oh-my-codebuddy:omc-setup` completed)
- HUD statusline installed (`/oh-my-codebuddy:hud setup`)
...
which omc || echo "Run: /oh-my-codebuddy:omc-setup"
...
- [ ] No active OMC operations running (`/oh-my-codebuddy:cancel --all`)
...
- **State cleanup**: Between demos, verify clean state with `/oh-my-codebuddy:cancel`
...
**Solution**: Jump to next phase or use `/oh-my-codebuddy:cancel` and show fallback
