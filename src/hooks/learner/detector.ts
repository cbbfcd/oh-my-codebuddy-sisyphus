...
Would you like me to extract this as a learned skill? Type \`/oh-my-codebuddy:skillify\` to save it (\`/oh-my-codebuddy:learner\` remains as a deprecated compatibility alias), or continue with your current task.
`.trim();
}
