 ...
 */
export declare function registerMcpWorker(teamName: string, workerName: string, provider: 'codex' | 'gemini' | 'claude' | 'codebuddy', model: string, tmuxTarget: string, cwd: string, workingDirectory: string): void;
/**
